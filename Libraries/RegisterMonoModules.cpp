...
extern "C"
{
	...
	extern gpointer*	mono_aot_module_Color3Runtime_info; // Color3Runtime.dll
	extern gpointer*	mono_aot_module_HOTweenMicro_info; // HOTweenMicro.dll
...
void RegisterMonoModules()
{
	...
	mono_aot_register_module(mono_aot_module_Color3Runtime_info);
	mono_aot_register_module(mono_aot_module_HOTweenMicro_info);
...
RegisterClass_Light();
extern int RegisterClass_CGProgram();
...
extern int RegisterClass_TerrainData();
RegisterClass_TerrainData();
extern int RegisterClass_TerrainCollider();
